            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="<?php echo e(url('/')); ?>" class="btn btn-default btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
      ...
      <ul class="sidebar-menu">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo e(url('adminpanel/sitesetting')); ?>">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo e(url('adminpanel/users')); ?>">
                <i class="fa fa-table"></i>All Users</a>
            </li>
            <li><a href="<?php echo e(url('adminpanel/users/create')); ?>">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo e(url('/adminpanel/categories')); ?>">
                <i class="fa fa-table"></i>All Categories</a>
            </li>
            <li><a href="<?php echo e(url('/adminpanel/categories/create')); ?>">
          ...
          <ul class="treeview-menu">
             ...
             <li><a href="<?php echo e(url('adminpanel/allmessage')); ?>">
          ...
          <ul class="treeview-menu">
             ...
             <li><a href="<?php echo e(url('adminpanel/photoslide')); ?>">
...
<!-- jQuery 2.2.3 -->
<?php echo Html::script('admin/plugins/jQuery/jquery-2.2.3.min.js'); ?>
...
<!-- FastClick -->
<?php echo Html::script('admin/plugins/fastclick/fastclick.js'); ?>
...
<!-- ChartJS 1.0.1 -->
<?php echo Html::script('admin/plugins/chartjs/Chart.min.js'); ?>


<!-- AdminLTE dashboard demo (This is only for demo purposes) -->
<!-- <?php echo Html::script('admin/dist/js/pages/dashboard2.js'); ?> -->

<!-- AdminLTE for demo purposes -->
<?php echo Html::script('admin/dist/js/demo.js'); ?>
