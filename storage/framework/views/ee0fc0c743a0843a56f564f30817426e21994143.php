...
<?php $__env->startSection('content'); ?>
 <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="<?php echo e(url('/adminpanel/categories/create')); ?>">Edit Category</a></li>
        ...
        <div class="row">
         ...
         <div class="box">
              <div class="box-header">
                <h3 class="box-title">Category Name  : <?php echo e($category->name); ?></h3>
              </div>
            <!-- /.box-header -->
              <div class="box-body">
          </div>
   ...
   <form class="form-horizontal" role="form" method="POST" action="<?php echo e(url('/adminpanel/categories/'.$category->id.'/update')); ?>">
