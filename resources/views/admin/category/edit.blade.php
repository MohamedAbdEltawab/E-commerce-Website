...
@section('content')
 <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="{{url('/adminpanel/categories/create')}}">Edit Category</a></li>
   ...
   <form class="form-horizontal" role="form" method="POST" action="{{ url('/adminpanel/categories/'.$category->id.'/update') }}">
    {{ csrf_field() }}
